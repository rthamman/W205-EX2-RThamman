...
################################################################################
twitter_credentials = {
    "consumer_key"        :  "euqDDUv753BS3niIov3hXEPAf",
    "consumer_secret"     :  "HDL1m5AgnKagUyP1MRFhTrsOezOrub6n8EMaieoN0JPppRVMH1",
    "access_token"        :  "19796792-7MbC1yOwUiA5avQVVt3ZvfKm58fjktQZulqVAGntM",
    "access_token_secret" :  "v8Kn8WbxG1HnvMb4LVPEtJ0gISyIJXDEj4nuUP9TpRkst",
}
...
class TweetStreamListener(tweepy.StreamListener):
    ...
    def on_status(self, status):
        self.listener.queue().put(status.text, timeout = 1000)
        return True
...
class Tweets(Spout):
    ...
    def next_tuple(self):
        try:
            tweet = self.queue().get(timeout = 1000) 
            if tweet:
